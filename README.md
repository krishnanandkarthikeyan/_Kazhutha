...
The server listens on PORT (3000 by default). `/api/health` reports protocol 3 and version 3.0.0. The deployable HTML is `dist/index.html`; `Kazhutha.html` is an identical downloadable copy.
